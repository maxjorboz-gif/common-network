...
import { Plus, Edit, Trash2, Check, X, Tag, Upload, DollarSign, Zap, FileSpreadsheet, Download, Link as LinkIcon, Copy } from 'lucide-react';
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="flex gap-2 mb-2 overflow-x-auto pb-1">
            <Button type="button" variant="outline" size="xs" className="whitespace-nowrap text-[10px] h-6 px-2 border-purple-300 text-purple-700 hover:bg-purple-50">
              ✨ Sofisticado
            </Button>
            <Button type="button" variant="outline" size="xs" className="whitespace-nowrap text-[10px] h-6 px-2 border-purple-300 text-purple-700 hover:bg-purple-50">
              ✨ Elegante
