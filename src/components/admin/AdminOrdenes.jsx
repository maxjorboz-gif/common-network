...
export default function AdminOrdenes({ comercio }) {
  ...
  const { data: ordenes = [], isLoading } = useQuery({
    queryKey: ['ordenes-admin', comercio.id_comercio],
    queryFn: async () => {
      const response = await base44.functions.invoke('obtenerOrdenes', {
        id_comercio: comercio.id_comercio // STANDARD
      });
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm text-gray-600">
                    ...
                    <div>
                      <span className="font-medium">Total:</span> ${orden.total?.toLocaleString('es-AR')}
                    </div>
                    <div>
